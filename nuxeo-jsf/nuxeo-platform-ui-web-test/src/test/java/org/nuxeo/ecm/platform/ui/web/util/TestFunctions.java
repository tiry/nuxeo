...
public class TestFunctions {
    ...
    public void testPrintFileSize() throws Exception {
        ...
        try (AutoCloseable jsfInfos = harness.deployTestContrib("org.nuxeo.ecm.platform.ui", url)) {
        ...
        try (AutoCloseable infos = harness.deployTestContrib("org.nuxeo.ecm.platform.ui", url)) {
