...
@RepositoryConfig(init = TestDocumentAuditPageProviderOperation.Populate.class)
public class TestDocumentAuditPageProviderOperation extends AutomationFeaturesTestCase {
