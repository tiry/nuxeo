...
public class TestMongoDBRepositoryJTAJCA extends MongoDBRepositoryTestCase {
    ...
    protected static class TxWarnChecker implements LogCaptureFeature.Filter {
     ...
     */
    @Test
    @LogCaptureFeature.FilterWith(TxWarnChecker.class)
    public void testAccessWithoutTx() throws ClientException, NoLogCaptureFilterException {
        TransactionHelper.commitOrRollbackTransaction();
        try {
