...
public class TestMarkLogicUpdateBuilder extends AbstractTest {
    ...
    private MarkLogicUpdateBuilder updateBuider;

    @Before
    public void before() {
        updateBuider = new MarkLogicUpdateBuilder(client.newJSONDocumentManager()::newPatchBuilder);
    }
    ...
    public void testBasicUpdate() throws Exception {
        ...
        String patch = updateBuider.apply(stateDiff).toString();
        assertJSONEquals("update-builder/basic-update.json", patch);
    }
