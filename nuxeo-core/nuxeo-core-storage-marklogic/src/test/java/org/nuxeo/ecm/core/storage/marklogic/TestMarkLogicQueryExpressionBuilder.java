...
public class TestMarkLogicQueryExpressionBuilder extends AbstractTest {
    ...
    public void testCoreFeatureQuery() throws Exception {
        ...
        // Test
        StructureWriteHandle query = new MarkLogicQueryExpressionBuilder(evaluator.getExpression(), evaluator.getSelectClause(),
                null, evaluator.pathResolver, evaluator.fulltextSearchDisabled).buildQuery();
        assertEquals(readJSONFile("query-expression/core-feature.json"), query.toString());
    }
