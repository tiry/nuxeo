 ...
 * @since 8.2
 */
public class DBSStateFlattener implements Function<State, Map<String, Serializable>> {

    public static final DBSStateFlattener STATE_FLATTENER = new DBSStateFlattener();

    @Override
    public Map<String, Serializable> apply(State state) {
        Map<String, Serializable> map = new HashMap<>();
        flatten(map, state, null);
        return map;
    }

    private void flatten(Map<String, Serializable> map, State state, String prefix) {
