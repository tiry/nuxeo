...
public class TestConstraintViolation extends NXRuntimeTestCase {
    ...
    public void setUp() throws Exception {
        ...
        this.field = this.schema.getField("firstname");
        this.constraint = ConstraintUtils.getConstraint(
                this.field.getConstraints(), PatternConstraint.class);
        this.violation = new ConstraintViolation(this.schema,
                Arrays.asList(this.field), this.constraint, INVALID);
    }

    @Test
    public void testGenericMessage() throws Exception {
        String expected = "generic";
        String message = this.violation.getMessage(Locale.ENGLISH);
    ...
    public void testConstraintSpecificMessage() throws Exception {
        ...
        String message = this.violation.getMessage(Locale.ITALIAN);
        assertEquals(expected, message);
    }
    ...
    public void testFieldSpecificMessage() throws Exception {
        ...
        String message = this.violation.getMessage(Locale.FRENCH);
        assertEquals(expected, message);
    }
    ...
    public void testNoTranslationForLanguageRepliesToDefault() throws Exception {
        String expected = "generic";
        String message = this.violation.getMessage(Locale.GERMAN);
        assertEquals(expected, message);
    }
