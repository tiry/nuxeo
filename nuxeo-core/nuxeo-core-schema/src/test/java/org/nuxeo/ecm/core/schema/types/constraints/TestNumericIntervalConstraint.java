...
public class TestNumericIntervalConstraint {
    ...
    static final String BAD = "pshitt";

    NumericIntervalConstraint minInMaxEx = new NumericIntervalConstraint(VAL2,
            true, VAL4, false);

    NumericIntervalConstraint minIn = new NumericIntervalConstraint(VAL2, true,
            null, false);
    ...
    private void genericTest(NumericIntervalConstraint constraint,
            boolean less, boolean lowerBound, boolean inner,
