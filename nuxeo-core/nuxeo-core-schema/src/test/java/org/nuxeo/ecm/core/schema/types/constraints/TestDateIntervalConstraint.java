...
public class TestDateIntervalConstraint {
    ...
    static final String NOV1 = "2014-11-01";

    static final String NOV2 = "2014-11-02";

    static final String NOV3 = "2014-11-03";

    static final String NOV4 = "2014-11-04";

    static final String NOV5 = "2015-11-05";

    static final String BAD = "2015pshitt-11paf-05";

    DateIntervalConstraint minInMaxEx = new DateIntervalConstraint(NOV2, true,
            NOV4, false);

    DateIntervalConstraint minIn = new DateIntervalConstraint(NOV2, true, null,
            false);
    ...
    private void genericTest(DateIntervalConstraint constraint, boolean less,
            boolean lowerBound, boolean inner, boolean upperBound,
            boolean greater) {
    ...
    @Test
    public void testDateIntervalConstraintHandleLongTimeMillis()
    ...
    public void testDateIntervalConstraintDescription() throws ParseException {
        ...
        assertEquals(new SimpleDateFormat("yyyy-MM-dd").parse(NOV2),
                params.get("Minimum"));
        assertTrue((Boolean) params.get("MinimumInclusive"));
        assertEquals(new SimpleDateFormat("yyyy-MM-dd").parse(NOV4),
                params.get("Maximum"));
        assertFalse((Boolean) params.get("MaximumInclusive"));
    }

    @Test
    public void testDateIntervalConstraintDescriptionOneBound()
            throws ParseException {
