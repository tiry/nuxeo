...
public class TestLengthConstraint {
    ...
    static final Long MIN = 5l;

    static final Long MAX = 10l;

    static final String LESS = "1234";

    static final String LOWER = "12345";

    static final String INNER = "1234567";

    static final String UPPER = "1234567890";

    static final String GREATER = "1234567890+";

    static final String BAD = "pshittt";
    ...
    private void genericTest(LengthConstraint constraint, boolean less,
