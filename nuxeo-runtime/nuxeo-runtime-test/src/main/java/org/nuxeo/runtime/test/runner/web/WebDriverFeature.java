...
public class WebDriverFeature extends SimpleFeature {
    ...
    public void initialize(FeaturesRunner runner) throws Exception {
        ...
        Browser browser = runner.getScanner().getFirstAnnotation(classToTest, Browser.class);
        ...
        HomePage home = runner.getScanner().getFirstAnnotation(classToTest, HomePage.class);
        if (home != null) {
